...
#chr start end binary: intad/ outtad / boundary / distance to boundary
bed <- cbind(as.character(sub[, 1]), sub[, 2]
             , sub[, 3], intad, notad, boundarytad, m)

colnames(bed) <- c("chr", "start", "end"
                   , "in_tad", "out_tad", "boundary", "distance")
